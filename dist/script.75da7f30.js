...
generateButton.addEventListener('click', makeNewScale); // Functions

function makeNewScale() {
  var randomKey = notesCheckbox.checked ? createRandom(keys) : "";
  var randomSign = notesCheckbox.checked ? createRandom(signs) : "";
